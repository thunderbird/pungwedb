...
import com.pungwe.db.utils.memory.MemoryUtil;
...
public class Memory {
	...
	static {
		// FIXME: Might be some clever trick we can use here later
	...
	public void expand(long bytes) {
		peer = allocator.reallocate(peer, bytes);
		size = bytes;
	}
